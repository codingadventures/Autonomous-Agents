...
{
    public class Runaway<T> : State where T : Bandit
    {
        ...
        public static Runaway<T> Instance { get { return Nested.instance; } }
        ...
        private class Nested
        {
            ...
            internal static readonly Runaway<T> instance = new Runaway<T>();
        }
        #endregion
        private void Runaway_Enter(object sender, AgentEventArgs<Agent> e)
        {
        ...
        {
            agent.Say("The Sheriff!!! RUUUUUUN!");
        }
    }
}
